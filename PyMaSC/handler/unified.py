...
class UnifiedCalcHandler:
    ...
    def _aggregate_worker_results(self, worker_results: List[Tuple[str, Any]]) -> None:
        ...
        try:
            ...
            logger.warning(f"New worker aggregation system failed, using legacy results: {e}")
            # Legacy system already processed results via _receive_results()
            # Just perform the final aggregation step
    ...
    def _collect_calculator_results(self, calculator: CrossCorrelationCalculator) -> None:
        ...
        try:
            ...
            logger.warning(f"New aggregation system failed, falling back to legacy: {e}")
            # Fall back to legacy aggregation
